        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="<?= base_url('assets/imgs/img-siswa/'.$siswa['img_siswa']) ?>" alt="Profile" class="rounded-circle">
              <h2><?= $siswa['nama_siswa'] ?></h2>
              <h3><?= $siswa['nis'] ?></h3>
              <div class="social-links mt-2">
                <a class="fs-6"><?= $siswa['nama_kejuruan']?></a>
              </div>
            </div>
          </div>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?= $siswa['tempat_lahir'].', '. $siswa['tanggal_lahir'] ?></div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?= $siswa['nope'] ?></div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?= $siswa['nama_kejuruan'] ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Kelas X</div>
                    <?php if( $siswa['kelas_1'] == null ) : ?>
                      <div class="col-lg-9 col-md-8">-</div>
                    <?php else : ?>
                      <div class="col-lg-9 col-md-8"><?= $siswa['kelas_1'] ?></div>
                    <?php endif; ?>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Kelas XI</div>
                    <?php if( $siswa['kelas_2'] == null ) : ?>
                      <div class="col-lg-9 col-md-8">-</div>
                    <?php else : ?>
                      <div class="col-lg-9 col-md-8"><?= $siswa['kelas_2'] ?></div>
                    <?php endif; ?>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Kelas XII</div>
                    <?php if( $siswa['kelas_3'] == null ) : ?>
                      <div class="col-lg-9 col-md-8">-</div>
                    <?php else : ?>
                      <div class="col-lg-9 col-md-8"><?= $siswa['kelas_3'] ?></div>
                    <?php endif; ?>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Tahun Ajaran</div>
                    <div class="col-lg-9 col-md-8"><?= $siswa['tahun_ajaran'] ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Status Siswa</div>
                    <div class="col-lg-9 col-md-8"><?= $siswa['status_siswa'] ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Tahun Keluar</div>
                    <?php if( $siswa['tahun_keluar'] == null ) : ?>
                      <div class="col-lg-9 col-md-8">-</div>
                    <?php else : ?>
                      <div class="col-lg-9 col-md-8"><?= $siswa['tahun_keluar'] ?></div>
                    <?php endif; ?>
                  </div>
                  ...
                  <form method="post" action="<?= base_url('Students/') ?>ubahSiswa" enctype="multipart/form-data">
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="<?= base_url('assets/imgs/img-siswa/'.$siswa['img_siswa']) ?>" alt="Profile">
                        <div class="pt-2">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="tempat_lahir" type="text" class="form-control" id="tempat_lahir" value="<?= $siswa['tempat_lahir'] ?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="tanggal_lahir" type="date" class="form-control" id="tanggal_lahir" value="<?= $siswa['tanggal_lahir'] ?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="nope" type="number" class="form-control" id="nope" value="<?= $siswa['nope'] ?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="email" type="email" class="form-control" id="email" value="<?= $siswa['email'] ?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <textarea name="alamat" id="alamat" value="" class="form-control"><?= $siswa['alamat'] ?></textarea>
                      </div>
                    </div>
                      ...
                      <div class="col-md-8 col-lg-9">
                        <select id="kode_kejuruan" class="form-select" name="kode_kejuruan" required oninvalid="this.setCustomValidity('Kelas Harus Diisi !')" oninput="setCustomValidity('')">
                          <?php foreach ($kejuruan as $jurusan) : ?>
                            <?php if( $jurusan['kode_kejuruan'] == $siswa['kode_kejuruan'] ) : ?>
                      ...
                      <div class="col-md-8 col-lg-9">
                        <select id="kelas_1" class="form-select" name="kelas_1" >
                          ...
                          <?php foreach ($kelas as $kls){
                            $selected = '';
                            if( $siswa['kelas_1'] == $kls['kode_kelas'] ){
                              $selected = 'selected';
                            }
                           ?>
                              <?php if( $kls['kelas'] == 'X' ) : ?>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <select id="kelas_2" class="form-select" name="kelas_2">
                          ...
                          <?php foreach ($kelas as $kls){
                            $selected = '';
                            if( $siswa['kelas_2'] == $kls['kode_kelas'] ){
                              $selected = 'selected';
                            }
                           ?>
                              <?php if( $kls['kelas'] == 'XI' ) : ?>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <select id="kelas_3" class="form-select" name="kelas_3">
                            ...
                            <?php foreach ($kelas as $kls){
                              $selected = '';
                              if( $siswa['kelas_3'] == $kls['kode_kelas'] ){
                                $selected = 'selected';
                              }
                            ?>
                      ...
                      <div class="col-md-8 col-lg-9">
                        <select name="status_siswa" id="status_siswa" class="form-select">
                          <?php foreach( $status_siswa as $stasis ) : ?>
                            <?php if( $stasis == $siswa['status_siswa'] ) : ?>
                      ...
                      <div class="col-md-8 col-lg-9">
                        <select name="kode_tahun_ajaran" id="kode_tahun_ajaran" class="form-select">
                          ...
                          <?php foreach( $tahunAjaran as $ta ) { $selected = ''; 
                            if( $ta['kode_tahun_ajaran'] == $siswa['kode_tahun_ajaran'] ){
                              $selected = 'selected';
                            }
                          ?>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="tahun_keluar" type="text" class="form-control" id="tahun_keluar" value="<?= $siswa['tahun_keluar'] ?>">
                      </div>
                    </div>

                    <input type="hidden" name="img_siswa_old" value="<?= $siswa['img_siswa'] ?>">
